...
class starter {
	public static void main(String args[]) {
		...
		System.out.println();
		System.out.println("This is your sentence encoded: " + Cipher.encode(sentence));
	//	System.out.println(Cipher.keyedEncode("bdu69w509 d0a 5 2zz3 0zu6507 d2539", 32));
	//	System.out.println(Cipher.keyedEncode("h5 tii alhp ot8fclap aptrmpc lb hcb m9tgn", 16));
	}
}
	/*	System.out.println(Cipher.encode("6v lvp u5vuy5 y1z5 qpsqy5r"));
		...
		int i = 1;
		while(i <= 36) {
			System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y", i));
			i++; 
		}
		int i = 1;
		while(i <= 36) {
			System.out.println(Cipher.keyedEncode("amlb mfhp7fcj jlgq fo tap s9a bjlslql aflipa lb hlg9b 210z t9ct", i));
			i++; 
		}
	*/	
